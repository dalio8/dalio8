import { Questao, Materia } from '@/types'

/**
 * Questões mockadas no formato CEBRASPE (Certo ou Errado)
 * 3 questões CERTAS e 2 questões ERRADAS
 */
...
export const questoesMockadas: Questao[] = [
  // QUESTÃO 1 - CERTA - Controle Externo
  {
    ...
    enunciado: 'De acordo com a Constituição Federal, compete ao Tribunal de Contas da União apreciar, para fins de registro, a legalidade dos atos de admissão de pessoal, a qualquer título, na administração direta e indireta, incluídas as fundações instituídas e mantidas pelo Poder Público, excetuadas as nomeações para cargo de provimento em comissão.',
    ...
    flashcard_resumo: 'TCU aprecia legalidade de atos de admissão de pessoal (exceto cargos em comissão) - Art. 71, III, CF/88',
    ano: 2024,
    banca: 'CEBRASPE',
    dificuldade: 'média',
  ...
  // QUESTÃO 2 - ERRADA - Direito Constitucional
  {
    ...
    enunciado: 'O poder constituinte derivado reformador é ilimitado, podendo alterar qualquer dispositivo da Constituição Federal, inclusive as cláusulas pétreas, desde que observado o procedimento qualificado de aprovação de emendas constitucionais.',
    ...
    flashcard_resumo: 'Poder Constituinte Derivado é LIMITADO: não pode alterar cláusulas pétreas (art. 60, §4º, CF/88)',
    ano: 2024,
    banca: 'CEBRASPE',
    dificuldade: 'média',
  ...
  // QUESTÃO 3 - CERTA - AFO
  {
    ...
    enunciado: 'A Lei de Diretrizes Orçamentárias compreenderá as metas e prioridades da administração pública federal, incluindo as despesas de capital para o exercício financeiro subsequente, orientará a elaboração da lei orçamentária anual e disporá sobre as alterações na legislação tributária.',
    resposta_correta: 'CERTO',
    ...
    flashcard_resumo: 'LDO: metas e prioridades + orienta LOA + alterações tributárias (Art. 165, §2º, CF/88)',
    ano: 2024,
    banca: 'CEBRASPE',
    dificuldade: 'fácil',
  ...
  // QUESTÃO 4 - CERTA - Direito Constitucional
  {
    ...
    enunciado: 'São funções institucionais do Ministério Público promover o inquérito civil e a ação civil pública, para a proteção do patrimônio público e social, do meio ambiente e de outros interesses difusos e coletivos.',
    resposta_correta: 'CERTO',
    ...
    flashcard_resumo: 'MP promove inquérito civil e ação civil pública para proteção de interesses difusos e coletivos (Art. 129, III, CF/88)',
    ano: 2024,
    banca: 'CEBRASPE',
    dificuldade: 'fácil',
  ...
  // QUESTÃO 5 - ERRADA - Controle Externo
  {
    ...
    enunciado: 'As decisões do Tribunal de Contas da União que resultem em imputação de débito ou multa têm eficácia de sentença judicial, não sendo necessária a propositura de ação de execução pelo Ministério Público ou pela Fazenda Pública para sua cobrança.',
    resposta_correta: 'ERRADO',
    ...
    flashcard_resumo: 'Decisões TCU com débito/multa = título executivo, mas PRECISA de ação de execução pela Fazenda Pública (Art. 71, §3º, CF/88)',
    ano: 2024,
    banca: 'CEBRASPE',
    dificuldade: 'média',
...
// Função helper para buscar questões por filtros
...
// Exportar também os flashcards gerados automaticamente
export function gerarFlashcards() {
